        ...
        <div class="col-md-10 col-md-offset-2 main">
          ...
          <form class="form-horizontal" role="form" action="update" method="post">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" name="isdn" placeholder="ISBN" value=${book.isdn}>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">书名</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="bookname" placeholder="书名" value=${book.bookname}>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">出版社</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="publish" placeholder="出版社" value=${book.publish}>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">作者</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="author" placeholder="作者" value=${book.author}>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">出版时间</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="time" placeholder="出版时间" value=${book.time}>
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-2 control-label">书本册数</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" name="total" placeholder="书本册数" value=${book.total}>
              </div>
            </div>
            <div class="form-group">
