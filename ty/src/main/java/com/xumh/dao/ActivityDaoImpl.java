...
public class ActivityDaoImpl extends HbBaseDao<Activity> implements ActivityDao {
	...
	public static final String GET_UNEND_ACTIVITIES = "from Activity a where a.endDate>current_date()";

	@Override
	public List<Activity> getUnexceedActivities() {
		List<Activity> activities = hibernateTemplate
				.find(GET_UNEXCEEDFULL_ACTIVITIES);
